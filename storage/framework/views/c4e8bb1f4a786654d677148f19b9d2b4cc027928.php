...
?>
<!DOCTYPE html>
    <html lang="en"  dir="<?php echo e(get_user_lang_direction()); ?>">
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32"  href="<?php echo e(asset('assets/favicon_package/favicon-32x32.png')); ?>">
                    ...
                    <li class="nav-item text-center">
                        <a class="nav-btn">
                            ...
                            <?php $__currentLoopData = $all_language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <?php if($user_select_lang_slug == $lang->slug): ?> 
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="slide__img d-block w-100"
                            src="<?php echo e(asset('assets/main-bg.jpg')); ?>" />
                    ...
                    <div class="carousel-item">
                        <img class="slide__img d-block w-100" src="<?php echo e(asset('assets/main-bg.jpg')); ?>" />
                        <div class="hero-content carousel-caption  container col-sm-12">
                            <div class="col-lg-9 col-md-10 text-start text-light">
                                <h1 class="hero-content__title text-end mb-5 fw-bolder">شركة الأهداف
                                    العربية للتجارة
...
<?php /**PATH D:\alahdf\@core\resources\views/frontend/partials/header.blade.php ENDPATH**/ ?>