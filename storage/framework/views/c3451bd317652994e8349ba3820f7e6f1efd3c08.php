...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Edit Last News Post')); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <a href="<?php echo e(route('admin.last-news')); ?>" class="btn btn-primary"><?php echo e(__('All News')); ?></a>
                        </div>

                        <form action="<?php echo e(route('admin.last-news.update',$blog_post->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-lg-8">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\alahdf\@core\resources\views/backend/pages/last-news/edit.blade.php ENDPATH**/ ?>