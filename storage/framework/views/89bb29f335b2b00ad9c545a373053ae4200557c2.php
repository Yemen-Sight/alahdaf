...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover','data' => ['url' => route('admin.last-news.delete',$data->id)]]); ?>
<?php $component->withName('delete-popover'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.last-news.delete',$data->id))]); ?>
...
<?php endif; ?> 
                                                    ...
                                                    <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.last-news.edit',$data->id)); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" target="_blank" href="#">
                                                        <i class="ti-eye"></i>
                                                    </a>
        ...
        $(document).ready(function() {
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.last-news.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\alahdf\@core\resources\views/backend/pages/last-news/index.blade.php ENDPATH**/ ?>