               ...
               <div class="view-order-details-info">
                   ...
                   <div class="view-order-top-wrap">
                       <div class="status-wrap">
                           <?php echo e(__('Order Status:')); ?> <span class="order-status-span"></span>
                       </div>
                       <div class="data-wrap">
                           <?php echo e(__('Order Date:')); ?> <span class="order-date-span"></span>
                       </div>
                   </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/backend/package-order-manage/order-manage-all.blade.php ENDPATH**/ ?>