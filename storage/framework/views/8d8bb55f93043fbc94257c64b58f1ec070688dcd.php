    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Case Study Items')); ?></h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if(!empty($work_section_img)): ?>
                                                        ...
                                                        <?php  $img_url = $work_section_img['img_url']; ?>
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php echo get_work_category_by_id($data->id,'string'); ?></td>
                                                <td><?php echo e(date_format($data->created_at,'d M Y')); ?></td>
                                                <td>
                                                     <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover','data' => ['url' => route('admin.work.delete',$data->id)]]); ?>
<?php $component->withName('delete-popover'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.work.delete',$data->id))]); ?>
...
<?php endif; ?> 
                                                    <a href="<?php echo e(route('admin.work.edit',$data->id)); ?>" class="btn btn-lg btn-primary btn-xs mb-3 mr-1 work_edit_btn">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <br>
                                                    <a target="_blank" href="<?php echo e(route('frontend.work.single',$data->slug)); ?>" class="btn btn-xs btn-info btn-sm mb-3 mr-1">
                                                        <i class="ti-eye"></i>
                                                    </a>
                                                    <form action="<?php echo e(route('admin.work.clone')); ?>" method="post" style="display: inline-block">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/backend/pages/works/work-index.blade.php ENDPATH**/ ?>