...
<div class="route my-5 h4">
    ...
    <a class="text-decoration-none text-muted fw-lighter" href="<?php echo e(url('/')); ?>"><?php echo e(__('Home')); ?></a>
                        ...
                        <?php $__currentLoopData = $pages_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           ...
                           / <a class="text-decoration-none text-muted fw-lighter" href="<?php echo e(url('/').'/'.get_static_option($page.'_page_slug')); ?>"> <?php echo e(get_static_option($page.'_page_' . $user_select_lang_slug . '_name')); ?></a>
                            <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\alahdf\@core\resources\views/frontend/pages/blog/blog-single.blade.php ENDPATH**/ ?>