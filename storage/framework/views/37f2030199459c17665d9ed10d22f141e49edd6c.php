                                        ...
                                        <?php else: ?>
                                            <?php if(!empty($product->variant)): ?>
                                                <?php $__currentLoopData = json_decode($product->variant); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $terms): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                        $variant_title = get_product_variant_list_by_id($id);
                                                    ?>
                                                        ...
                                                        <div class="product-variant-list-wrapper">
                                                            ...
                                                            <ul class="product-variant-list">
                                                                <?php $__currentLoopData = $terms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <li data-variantid="<?php echo e($id); ?>" data-variantname="<?php echo e($variant_title); ?>" data-term="<?php echo e($term); ?>"><?php echo e($term); ?></li>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </ul>
                                                        </div>
                                                    <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/doorianclothing2/app9.doorianclothing.net/@core/resources/views/frontend/pages/products/product-single.blade.php ENDPATH**/ ?>