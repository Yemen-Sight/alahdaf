    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('All Posted Jobs')); ?></h4>
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <?php $a=0; ?>
                            <?php $__currentLoopData = $all_jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="nav-item">
                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            <?php $__currentLoopData = $job; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($data->vacancy); ?></td>
                                                    <td><?php echo e(get_jobs_category_by_id($data->category_id)); ?></td>
...
<?php endif; ?> 
                                                        ...
                                                        <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.jobs.edit',$data->id)); ?>">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-lg btn-info btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.jobs.single',$data->slug)); ?>">
                                                            <i class="ti-eye"></i>
                                                        </a>
                                                        <form action="<?php echo e(route('admin.jobs.clone')); ?>" method="post" style="display: inline-block">
                                                            <?php echo csrf_field(); ?>
        ...
        $(document).ready(function() {
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "<?php echo e(route('admin.jobs.bulk.action')); ?>",
                        'data' : {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/nexelit/@core/resources/views/backend/jobs/all-jobs.blade.php ENDPATH**/ ?>