            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="widget-area">
                        <?php if(time() >= strtotime($event->date)): ?>
                            <p class="alert alert-danger"><?php echo e(get_static_option('event_single_'.$user_select_lang_slug.'_event_expire_text')); ?></p>
                        <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/doorianclothing2/app9.doorianclothing.net/@core/resources/views/frontend/pages/events/event-single.blade.php ENDPATH**/ ?>