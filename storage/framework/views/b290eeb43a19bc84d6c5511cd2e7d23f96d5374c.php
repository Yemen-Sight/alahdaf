...
<?php endif; ?> 
                                                    ...
                                                    <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" href="<?php echo e(route('admin.blog.edit',$data->id)); ?>">
                                                        <i class="ti-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" target="_blank" href="<?php echo e(route('frontend.blog.single', $data->slug)); ?>">
                                                        <i class="ti-eye"></i>
                                                    </a>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/doorianclothing2/app9.doorianclothing.net/@core/resources/views/backend/pages/blog/index.blade.php ENDPATH**/ ?>