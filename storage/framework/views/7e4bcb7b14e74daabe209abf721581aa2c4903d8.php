...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('New Last News Post')); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('Add New Last News Post')); ?></h4>
                            <a href="<?php echo e(route('admin.last-news')); ?>" class="btn btn-primary"><?php echo e(__('All Blog')); ?></a>
                        </div>

                        <form action="<?php echo e(route('admin.last-news.new')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                <div class="col-lg-8">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change','#language',function(e){
               ...
               $.ajax({
                  url: "<?php echo e(route('admin.last-news.lang.cat')); ?>",
                  type: "POST",
                  data: {
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\alahdf\@core\resources\views/backend/pages/last-news/new.blade.php ENDPATH**/ ?>