                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            @foreach($job as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->position}}</td>
                                                    <td>{{$data->vacancy}}</td>
                                                    <td>{{get_jobs_category_by_id($data->category_id)}}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" href="{{route('admin.jobs.edit',$data->id)}}">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-lg btn-info btn-xs mb-3 mr-1" target="_blank" href="{{route('frontend.jobs.single',$data->slug)}}">
                                                            <i class="ti-eye"></i>
                                                        </a>
