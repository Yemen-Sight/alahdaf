                                        ...
                                        <table class="table table-default" id="all_blog_table">
                                            ...
                                            @foreach($article as $data)
                                                <tr>
                                                    ...
                                                    <td>{{$data->id}}</td>
                                                    <td>{{$data->title}}</td>
                                                    <td>{{get_topic_name_by_id($data->topic_id) ? get_topic_name_by_id($data->topic_id) : __('Uncategorized') }}</td>
                                                    <td>{{$data->views}}</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <x-delete-popover :url="route('admin.knowledge.delete',$data->id)"/>
                                                        <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" href="{{route('admin.knowledge.edit',$data->id)}}">
                                                            <i class="ti-pencil"></i>
                                                        </a>
                                                        <a class="btn btn-lg btn-info btn-xs mb-3 mr-1" target="_blank" href="{{route('frontend.knowledgebase.single',$data->slug)}}">
                                                            <i class="ti-eye"></i>
                                                        </a>
