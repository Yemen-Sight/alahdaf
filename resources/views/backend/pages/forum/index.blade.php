                                    ...
                                    <table class="table table-default" id="all_blog_table">
                                        ...
                                        @foreach($blog as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <x-delete-popover :url="route('admin.forum.delete',$data->id)"/>
                                                   
                                                    <a class="btn btn-lg btn-primary btn-xs mb-3 mr-1" href="{{route('admin.forum.edit',$data->id)}}">
                                                        <i class="ti-pencil"></i>
                                                    </a>
        ...
        $(document).ready(function() {
            $(document).on('click','#bulk_delete_btn',function (e) {
                ...
                if(allIds != '' && bulkOption == 'delete'){
                    ...
                    $.ajax({
                        'type' : "POST",
                        'url' : "{{route('admin.forum.bulk.action')}}",
                        'data' : {
                            _token: "{{csrf_token()}}",
                            ids: allIds
                        },
