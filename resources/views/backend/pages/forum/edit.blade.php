                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <a href="{{route('admin.forum')}}" class="btn btn-primary">{{__('All News')}}</a>
                        </div>

                        <form action="{{route('admin.forum.update',$blog_post->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
