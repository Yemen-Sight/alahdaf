                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{__('Add New Last News Post')}}</h4>
                            <a href="{{route('admin.forum')}}" class="btn btn-primary">{{__('All Blog')}}</a>
                        </div>

                        <form action="{{route('admin.forum.new')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('change','#language',function(e){
               ...
               $.ajax({
                  url: "{{route('admin.forum.lang.cat')}}",
                  type: "POST",
                  data: {
                      _token : "{{csrf_token()}}",
                      lang : selectedLang
