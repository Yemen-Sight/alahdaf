                            ...
                            <div class=" col-md-6 col-lg-4 mb-5">
                                <a href="{{route('frontend.blog.single',$data->slug)}}"
                                    ...
                                    <div class="card border overflow-hidden shadow">
                                        <div class="">
                                            {!! render_image_markup_by_attachment_id($data->image,'card-img') !!}
                                        </div>
                                        <div
                                            class="card-body text-light bg-dark bg-opacity-75 border-4">
                                            <h2 class="card-title mb-4">{{$data->title}}</h2>
                                            <p>{{$data->excerpt}}</p>
                                            <div class="d-flex gap-4 align-items-center">
                                                <img class="avatar"
                                                    src="./assets/avatar/avatar.jpeg"
                                                    alt="man">
                                                <p class="h4">{{$data->author}}</p>
                                            </div>
                                            <div class="d-flex gap-5 align-items-center my-3 me-4">
                                                ...
                                                <p class="h5 fw-lighter"> {{date_format($data->created_at,'d / m / Y')}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </a>
